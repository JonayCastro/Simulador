...
class Main(wx.Frame):
    def __init__(self):
        ...
        self.lima = ['0', '1', '2', '3', '4', '5', '10', '15', '20', '25', '30', '40', '50', '60', '70', '80', '100']
        self.tiempos = ['10000', '30000', '50000', '60000', '70000', '80000', '90000', '100000']
        ...
        self.selti1 = wx.Choice(self, -1, choices=self.tiempos)
        self.selti1.SetSelection(0)
        ...
        self.selma2.SetSelection(6)
        sizev6.Add(matex2, flag=wx.RIGHT|wx.LEFT, border=2)
        sizev6.Add(self.selma2, flag=wx.RIGHT|wx.LEFT, border=2)
        sizeh2.Add(sizev6)

        self.bu = wx.BitmapButton(self, -1, bitmap=wx.Bitmap('iconos/ir.png'), size=(98, 32))
        self.panel = wx.Panel(self, -1)
        self.panel.SetBackgroundColour(wx.BLACK)

        sizev1.Add(sizeh1, flag=wx.ALL, border=10)
        sizev1.Add(sizeh2, flag=wx.LEFT, border=85)
        sizev1.Add(self.bu, flag=wx.ALL, border=10)
        sizev1.Add(self.panel, proportion=1, flag=wx.EXPAND|wx.RIGHT|wx.LEFT|wx.BOTTOM, border=10)
        self.SetSizer(sizev1)

        self.Bind(wx.EVT_BUTTON, self.Acti)
        
    def Acti(self, event):
        self.panel.Refresh()
        self.t = self.selti1.GetStringSelection()
        self.v1x = self.selve1x.GetStringSelection()
        self.v1y = self.selve1y.GetStringSelection()
        self.v2x = self.selve2x.GetStringSelection()
        self.v2y = self.selve2y.GetStringSelection()
        self.m1 = self.selma1.GetStringSelection()
        self.m2 = self.selma2.GetStringSelection()
        self.Dibu()
    ...
    def Dibu(self):
        ...
        y1 = (y / 2) + 150
        masa_1 = int(self.m1)
        velocidad_x1 = float(self.v1x)
        velocidad_y1 = float(self.v1y)
        
        x2 = (x / 2) - 150
        y2 = (y / 2) - 150
        masa_2 = int(self.m2)
        velocidad_x2 = float(self.v2x)
        velocidad_y2 = float(self.v2y)
